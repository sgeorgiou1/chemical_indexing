...
fileloc = "C:\\Users\\sgeorgiou\\OneDrive - Institution of Engineering and Technology\\Documents\\ChemIndexing\\ChemPapers\\files\\"
...
def chem_extract(xml_location): # extract chemical indexing from inspec2 xml messages
    ...
    for file in tqdm(os.listdir(xml_location)):
        ...
        ind_dict[file[:-4]] = {'title':title, 'abstract':abstract, 'chems':chems, 'roles':roles, 'states':states} #create dictionary entry for all info, item id is the key, value is a dictionary of details title,abs (strs) and chems,roles,states (lists)
